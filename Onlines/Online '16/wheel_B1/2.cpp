...
void Wheel(){
	...
	if((GRID_DIFF*GRID_COUNT)<pos.y)
    {
        glTranslatef(0,0,(pos.y-GRID_DIFF*GRID_COUNT)*sin(INCLINE_ANGLE));
		//glRotatef(wheel_inc_angle , 0,0,1);
    }
...
void display(){
	...
	****************************/
	...
	glPushMatrix();
    {
        glTranslatef(0,GRID_DIFF*GRID_COUNT,67);
